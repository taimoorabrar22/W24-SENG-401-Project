    ...
    return (
        <div className="container bg-[#1b4235] text-white h-[100%] flex flex-col-reverse md:flex-row w-[100%] max-w-full">
            ...
            <h2 className="text-red-200 font-rozha font-helvetica text-[74px] font-extrabold text-center font-normal tracking-normal leading-normal mt-10 mb-10">
                ...
                <NavLink to="/register" className="border-2 py-4 bg-[#EDD3C5] text-[#1b4235] px-6 border-black rounded-xl text-[25px] text-center hover:bg-[#2F4858] hover:text-white transition max-w-80 justify ease-in-out duration-300 hover:scale-105 hover:shadow-lg">create an account </NavLink>
                </div>
